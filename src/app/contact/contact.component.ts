...
export class ContactComponent implements OnInit, OnDestroy {
  ...
  getDni(dni: string) {
    this.contactForm.addControl('dni', new FormControl(['', [Validators.required, Validators.minLength(3)]]))
    this.contactForm.get('dni')?.setValue(dni)
    this.contactForm.get('dni')?.updateValueAndValidity()
  }
